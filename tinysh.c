...
#ifndef BUFFER_SIZE
#define BUFFER_SIZE 	((40*4)+20)			//256
#endif
#ifndef HISTORY_DEPTH
#define HISTORY_DEPTH 	10					// 16
#endif
#ifndef MAX_ARGS
#define MAX_ARGS 		(5)					// 16
#endif
#ifndef PROMPT_SIZE
...
static uchar input_buffers[HISTORY_DEPTH][BUFFER_SIZE + 1];
static uchar trash_buffer[BUFFER_SIZE + 1];
static uchar context_buffer[BUFFER_SIZE + 1];
static int cur_buf_index = 0;
static int cur_context = 0;
static int cur_index = 0;
static int echo = ECHO_MODE;
...
/*********************************************************************
 * @name	: tinysh_longhex
 * @brief	: string to hexadecimal conversion (n bytes)
 *********************************************************************/
unsigned long tinysh_hex(char *s, int bytesCnt)
{
  unsigned long res=0;
  int index = 0;
  int ishex=1;
